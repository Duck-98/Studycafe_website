    ...
    <div class="window">
        <div class="upside">
                <table class="tableLayer">
                    <tr> <!--1-->
                        <td colspan="2" rowspan="4"><button id="s_a" class="usable">스터디룸 1</button></td>
                        <td></td>
                        <td><button id="p_a" class="usable">1</button></td>
                        <td><button id="p_b" class="usable">2</button></td>
                        <td><button id="p_c" class="usable">3</button></td>
                        <td><button id="p_d" class="usable">4</button></td>
                        <td><button id="p_e" class="usable">5</button></td>
                        <td><button id="p_f" class="usable">6</button></td>
                    ...
                    <tr> <!--2-->
                        ...
                        <td></td> <td></td> <td></td> <td></td>
                        <td colspan="2" rowspan="2"><button id="c_a" class="usable">스터디룸 3</button></td>
                    </tr>
                    <tr> <!--3-->
                        <td></td>
                        <td colspan="6" rowspan="2"><bUtton id="d_a" class="usable">공용 테이블 1</button></td>
                        <td></td>
                    </tr>
                    <tr> <!--4-->
                        <td></td> <td></td>
                        <td colspan="2" rowspan="2"><button id="c_b" class="usable">스터디룸 4</button></td>
                    </tr>
                    <tr> <!--5-->
                        <td colspan="2" rowspan="4"><button id="s_b" class="usable">스터디룸 2</button></td>
                        <td></td> <td></td> <td></td> <td></td>
                        <td></td> <td></td> <td></td> <td></td>
                    </tr>
                    <tr> <!--6-->
                        <td></td>
                        <td colspan="6" rowspan="2"><bUtton id="d_b" class="usable">공용 테이블 2</button></td>
                        <td></td>
                        <td colspan="2" rowspan="2"><button id="c_c" class="usable">스터디룸 5</button></td>
                    </tr>
                    <tr> <!--7-->
                        <td></td> <td></td>
                    </tr>
                    <tr> <!--8-->
                        ...
                        <td></td> <td></td> <td></td> 
                        <td colspan="2" rowspan="2"><button id="c_d" class="usable">스터디룸 6</button></td>
                    </tr>
                    <tr> <!--9-->
                        <td></td> <td></td> <td></td> <td></td> <td></td>
                        <td></td> <td></td> <td></td> <td></td> <td></td>
            ...
            <div class="inputBox">
                    ...
                    <input type="submit" id="reserve" value="예약하기" onclick="join_success()">
            </div>
        </div>
                </form>
